...
function printCards(carta, index){
    ...
    var etiquetaAuxiliar = "</div><div><p class='energy'>"+energy+"</p><div class='contenedor-hability'><p class='hability'>"+hability+"</p></div><p class='description'>"+description+"</p><div class='icons-card'><img loading='lazy' id='bg-atk' class='image-icon-card' src='"+BACKGROUND_STATS+"' alt=''><img loading='lazy' id='bg-def' class='image-icon-card' src='"+BACKGROUND_STATS+"' alt=''><img loading='lazy' id='icon-atk' class='image-icon-card' src='"+ICON_ATTACK+"' alt=''><p style='left:"+LEFT_PIXEL_ATTACK_DISTANCE+"' id='atk-value'>"+attack+"</p><img loading='lazy' id='icon-def' class='image-icon-card' src='"+ICON_DEFENSE+"' alt=''><p style='left:"+LEFT_PIXEL_DEFENSE_DISTANCE+"' id='def-value'>"+defense+"</p></div><img loading='lazy' class='card-image' src='"+url+"' alt=''></div></div>"
